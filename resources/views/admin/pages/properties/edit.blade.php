                ...
                <form action="{{ route('admin.property.update', $property->id) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="file" id="thumbnail" name="thumbnail"
                                    value="{{ old('thumbnail') }}" required="" accept="image/jpeg,image/jpg,image/png,image/webp" onchange="previewThumbnail(event)">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="file" id="images" name="images[]"
                            value="{{ old('images') }}" multiple accept="image/jpeg,image/jpg,image/png,image/webp" onchange="previewGallery(event)">
